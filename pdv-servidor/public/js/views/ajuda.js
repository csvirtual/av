...
const TOPICS = [
  {
    ...
    html: `
      ...
      <div class="tip"><strong>Primeira coisa a fazer:</strong> loga com <code>admin</code>/<code>admin123</code> e troca essa senha (tela <strong>Usuários</strong>) — ela é a mesma em toda instalação nova, então só continua segura enquanto ninguém de fora souber que você não trocou. Repare que o primeiro login já abre <strong>nesta própria tela de Ajuda</strong>, em vez do Painel — de propósito, pra já ter esse guia na mão antes de mexer em qualquer coisa (veja o porquê logo abaixo, em "Entrando todo dia").</div>
