      ...
      <div class="card" style="max-width:760px;margin-bottom:20px;">
        ...
        ${license.keyIssue ? `
          <div class="notice-card">
            ...
            <p>${escAttr(license.keyIssue)} Isso costuma acontecer depois de restaurar um backup com o CNPJ diferente do que estava quando a chave foi ativada — confira se o CNPJ abaixo está correto, ou cole a chave de novo.</p>
          </div>
        ` : ''}
