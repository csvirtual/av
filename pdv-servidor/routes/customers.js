...
router.delete('/:id', (req, res) => {
  ...
  broadcast(TOPIC_CUSTOMERS_CHANGED, { reason: 'deleted', id: req.params.id }, req.tenantId);
  res.json({ ok: true });
});
...
router.post('/:id/pagamento', (req, res) => {
  ...
  try {
    ...
    broadcast(TOPIC_CUSTOMERS_CHANGED, { reason: 'payment', id: req.params.id }, req.tenantId);
